      ...
      <section className="dynamic-display">
        ...
        <div className="presentation-paragraphs">
          ...
          <div className="presentation-paragraph">
            ...
            <p>Once you are signed in and found a recipe you would like to cook, select it.</p>
          </div>
          <div className="presentation-paragraph">
            <Icon name="list alternate outline" size="big" color="grey" />
            <p>Click on "Add to a grocery list". It will <em>automatically</em> generate a grocery list. Simple, easy.</p>
          </div>
        </div>
      </section>
